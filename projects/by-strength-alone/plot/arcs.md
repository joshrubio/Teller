...
> ¿Qué es ser realmente fuerte?

Para alguien cuyo Domain *es* la fuerza — F = ma, masa y aceleración como variables simultáneas — esa pregunta no es abstracta. Es la pregunta de su identidad. Cada arco testea una dimensión distinta. La respuesta nunca se da directamente — se acumula en lo que Park hace y en lo que le cuesta.
...
|---|---|---|---|
| **1** | Hartford — zona Principado, Potestad generada | ¿Es fuerza saber cuándo el protocolo está equivocado y actuar de todas formas? | 5–6 |
| **2** | Seoul — Ji-ho + Kiki presentes, Park solo al final → Rango 3 | ¿Es fuerza ganar cuando alguien que podría hacerlo por ti te está mirando? | 6–7 |
...
| **Bridge** | Convocatoria a Valais → empalme con Libro 1 Cap 54 | — | 2–3 |
...
**Cliffhanger rule:** cada capítulo cierra con información nueva que cambia lo que el lector creía saber sobre la situación o sobre Park.

---

## Arc 2 — Seoul

**Mission:** M5. Primera resolución limpia como lead → Rango 3. Pero el padre dirige la rama coreana. Ji-ho (Rango S) y Ki-yeon (17, mismo Domain, control de masa superior) son convocados junto a Park.

**Key beats:**
- Llegada a Seoul: la presión familiar no se nombra, se ve en cómo el padre gestiona la sala.
- Ji-ho evalúa a Park y a Kiki en paralelo — sin decirlo. La comparación existe en los márgenes.
- La misión escala. Ji-ho retira a Kiki del frente activo y deja a Park solo frente a la Potestad Nivel 3.
- Park la resuelve. Rango 3 confirmado.
- Pregunta no resuelta: ¿Ji-ho lo dejó solo porque confiaba en él — o porque sabía que Kiki ya era suficiente y quería ver qué hacía Park sin red?

**Dramatic arc question:** ¿Es fuerza ganar cuando alguien que podría hacerlo por ti te está mirando?
...
**Mission:** M8. Interior de Venezuela (región de Sorte, Yaracuy), ~23 dic 2025 – 5 ene 2026 — antes, durante y un par de días después de la captura real de Maduro (3 enero 2026). La fase Caracas/Yara Montiel (LoD Libro 1 Cap 53) queda fuera de este arco, sin cambios por ahora.
...
Empalme con Libro 1 Cap 54. Park recibe la llamada de Voss. El lector de BSA sabe lo que Park no sabe todavía: fue colocado por Voss, no asignado por AMAT-NA. Lo que Park cree que es un nuevo destino es otra cosa.
