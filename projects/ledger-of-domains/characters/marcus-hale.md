...
module: characters
tags: [amat-na, libro-2, institucional, antagonista-ambiguo]
relations: [voss, oliver]
load-with: [characters/voss]
updated: 2026-07-25
---

# Marcus Hale — Director regional AMAT-NA

## Profile

| | |
|---|---|
| **Rol** | Director regional de AMAT-NA desde hace 8 años. Superior de Cartwright en el organigrama (Cartwright gestiona solo una parte pequeña de la rama de USA, sin voto real propio). |
...
| Person | Dynamic |
|---|---|
| Voss | Se conocen de lejos más que de cerca. Oferta de ayuda con precio ambiguo, ligado a Oliver. |
| Oliver | No lo conoce en persona — pero ya lo trata como pieza de valor institucional, "chico estrella". |
