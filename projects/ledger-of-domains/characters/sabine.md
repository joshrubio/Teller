...
module: characters
tags: [ancla-domain, nivel-1, colaboracion-formal, centro-valais, partida]
relations: [oliver, lev, pier, petra, asha]
load-with: [system/domains, world/centro-valais]
updated: 2026-06-17
---

# Sabine — Ancla (Nivel 1) / Formal Collaboration
...
| **Name** | Sabine |
| **Age** | 26 |
| **Appearance** | Cabello castaño medio, liso, habitualmente suelto pero sin cuidado visible — ni arreglado ni descuidado. Ojos verde grisáceo. Piel blanca europea con algo de color de años en interiores institucionales. 1.72 m, complexión delgada con tensión física contenida que no se ve a primera vista — el Domain es contención, y lo lleva en el cuerpo. Ascendencia francesa o alemana. Sin cicatrices visibles — el accidente que activó el Domain no dejó rastro externo. Esencia: jabón neutro, nada más. |
...
| **Level** | 1 (crítico) |
| **Status** | **DEPARTED** — planificada durante irrupción Cap 69 |

## Arrival

Domain manifestó en defensa — alguien intentó golpearla y no pudo moverse. AMAT la encontró a través de patrones en registros médicos. El Centro es el hogar más estable que ha tenido.

## Collaboration terms

Disponible para contención dentro del Centro cuando un sujeto pierde control. Activaciones externas de bajo riesgo (máx. 4 anuales, objetivo comunicado con antelación). Vivienda garantizada, atención médica, estipendio menor.

**Subtext:** AMAT lo sabe. La estabilidad tiene un valor específico para ella que hace el trato más favorable para la agencia de lo que parece en papel. El acuerdo más asimétrico de los tres colaboradores — y ella es consciente de ello.

## Domain mechanics

Fija objetos o personas — inamovibles sin importar la fuerza. No puede moverse ella misma mientras mantiene múltiples anclas simultáneas.
...
**Oliver post-partida:** lleva el Domain de Ancla en el cuerpo — integración estable. La copia no desaparece cuando la portadora se va. Cap 71: Riku: "Sabine." Oliver: "Ya." Sin elaborar.

## Libro 2, Cap 88 (POV, excepción — junto con Lev)
...
## Libro 2, Cap 93 (POV Park, vista externa)
...
- El Centro era el hogar más estable que había tenido. Su partida con Lev tiene el mayor coste del cast — eligió irse del único lugar que fue suyo.

## Key relations

| Person | Dynamic |
|---|---|
| Oliver | Parte del acuerdo Cap 45. La mecánica de información fue su reserva explícita — Oliver la recibió sin argumentar. |
