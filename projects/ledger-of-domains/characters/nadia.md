...
module: characters
tags: [impulso-domain, nivel-2, integracion-funcional, centro-valais]
relations: [oliver]
load-with: [system/domains, world/centro-valais]
updated: 2026-06-17
---

# Nadia — Impulso (Nivel 2) / Functional Integration
...
| **Name** | Nadia |
| **Age** | 25 |
| **Appearance** | Cabello castaño oscuro, liso, hasta los hombros — ordenado sin esfuerzo aparente. Ojos marrón cálido. Piel de tono medio cálido — ascendencia del norte de África o Levante árabe. 1.70 m, complexión media con tono ligero: más de libros que de campo. Sin marcas de edad ni cicatrices. Esencia: algo limpio y académico con nota floral discreta. |
| **Origin** | Hija de oficial AMAT (burocrático). Conocía la teoría del sistema, no la práctica. |
| **Domain** | Impulso — genera fuerza dirigida sin contacto físico. Empujones, lanzamientos, impacto a distancia. Solo línea recta — no puede curvar. |
| **Level** | 2 (alto) |
| **Status** | Integración funcional |

## Arrival

Domain manifestó en ella; su padre (oficial AMAT burocrático) la envió antes de que lastimara a alguien. Conocía el vocabulario AMAT antes de llegar — AMAT la conoce a través del expediente de su padre antes de conocerla a ella.

## Personality

Académicamente inclinada, teóricamente sólida. La brecha entre saber el sistema y vivirlo desde dentro es parte de su arco implícito.

## Domain mechanics

Fuerza dirigida sin contacto, línea recta únicamente. La limitación no es de potencia — es de geometría.

**Tactical limit (Cap 70):** desplazó clúster sur contra la pared con impacto seco — tres unidades cayeron. Las demás se dividieron en cuatro fragmentos más pequeños y empezaron a reagruparse. "Siguen", dijo. Impulso en línea recta funciona para desplazamiento masivo, no para eliminación de hive mind.

## Cap 58 — Juego de Dominios
...
<!-- canonical -->
Simulacro de descenso en rappel multi-punto, cubriendo el punto medio junto a Oliver. Durante el tramo de aproximación, combina Impulso hacia fuera (empujándose lateralmente hasta el siguiente anclaje sin soltar del todo la cuerda) e Impulso hacia dentro (frenando el propio balanceo al llegar) en el mismo instante — primera vez que usa las dos direcciones a la vez, evolución directa del avance de Cap86. Le ahorra ~4 segundos por punto de reenvío; es la clave técnica de que Valais alcance al grupo de Johanna, que salía sesenta segundos por delante. **Corregido 2026-07-24:** no es ella quien sufre el accidente del anclaje (fue Petra, no Nadia — evita repetir lesión sobre el mismo personaje en el libro); su beat de Cap97 queda como demostración de habilidad bajo presión, no como rescate de sí misma.
...
- Libro 2: primera grieta visible entre lo que muestra al grupo y lo que siente — construye hacia Cap 94.

## Key relations

| Person | Dynamic |
|---|---|
| Oliver | Pendiente de copia deliberada (Arco 3 mid). Sin tensión establecida todavía. |
| AMAT (vía padre) | Conoce el sistema antes de vivirlo — ambas cosas a la vez. |
