...
module: characters
tags: [family, park, amat-kr, lineage]
updated: 2026-07-02
---

# Familia Park — Árbol genealógico

Linaje suhoja de la costa occidental. Cinco generaciones documentadas antes de AMAT-KR (1954). Familia fundadora de la rama coreana.

## Árbol activo (generación presente)

```
Park Taeho (박태호) — ~52 — Director AMAT-KR
│
├── Park Jun-ho (박준호) — ~24 — protagonista BSA
│   └── madre: fallecida
│
└── Ki-yeon / Kiki (박기연) — ~17 — evaluación AMAT activa
    └── madre: distinta (no establecida)

Park Ji-ho (박지호) — ~47 — Rango S — hermano menor de Taeho
```
