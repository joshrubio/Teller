...
relations: [yegor, rasmus-lindqvist]
load-with: [world/san-gotardo]
updated: 2026-07-24
---

# Lukas Feldmann — Candidato militar, #10

## Profile

| | |
|---|---|
| **Full name** | Lukas Feldmann |
| **Nationality** | Alemana/suiza (a precisar — provisional) |
| **Tablero** | #10 de 213 |
| **Rol narrativo** | Miembro del club de pelea informal — descrito solo por número/físico en el manuscrito (Cap53), nombre reservado para escena futura. |
...
| Person | Dynamic |
|---|---|
| Yegor | Sigue su iniciativa sin cuestionarla. |
| Rasmus Lindqvist | Ambos presentes cuando Rasmus le cierra el paso a Oliver. |
