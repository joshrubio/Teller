...
# Anton Reber — Instructor de Combate, San Gotardo

## Perfil

| | |
|---|---|
| **Nombre completo** | Anton Reber |
| **Rol** | Instructor principal de la pata Combate en El Reducto |
...
No son cercanos, pero se conocen de las mismas décadas de servicio a AMAT — un respeto seco, sin calidez visible, entre dos personas que han pagado costes distintos por el mismo tipo de trabajo. Ambos, por separado, mencionan al director del centro con el mismo peso institucional — nunca aparece en Libro 2, pero su autoridad es real y ambos la citan como techo de lo que ellos mismos pueden decidir.

## El director — referencia, sin aparición

Mencionado por Reber y por Anke, nunca visto en Libro 2. Nombre de trabajo: **Kessler**. Basta con que exista como límite de autoridad citado por ambos — figura reservada para un libro posterior si hace falta desarrollarla.
