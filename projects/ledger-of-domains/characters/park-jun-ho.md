...
| **Rank** | Agente de Campo Rango 4 al inicio → Rango 2 por Cap 54 |
...
**What he hides:** fue asignado al Centro por Voss, no por AMAT-NA ("necesito saber si hay alguien prestando atención"). No lo sabe al llegar (Cap 54–55). Libro 2 Cap 76 (numeración absoluta): empieza a notar patrones sin confirmación — sin revelación todavía, Voss ausente (en Ginebra). Sin fecha fija para cuando lo descubra — cuando pase, cambia cómo lee su propia presencia ahí.
...
- Seco, económico.
- Advertencias sin explicar la razón.
- Humor negro en cierre de alta tensión.
- No rellena silencios — los usa como información.
...
## Two internal narration layers (BSA — established Cap 8)
...
<!-- canonical -->
- Espalda apoyada en superficies al reagruparse o evaluar (Cap 2 callejón, Cap 3 pared).
- Leve encogimiento de hombros al desviar una pregunta o simplificar (Cap 1).
- Leve ladeado de cabeza al dudar entre opciones — no duda de verdad, considera (Cap 1).
- Quietud anticipatoria junto a ventanas, manos en bolsillos, mirando sin que nada le llame (Cap 1 — ve el apagón antes de que Oliver lo note).
- La pausa antes de responder no es duda: es filtrado — selecciona cuánto decir (Cap 3).
- Autoevaluación de daño físico con economía de movimientos: funcional o no funcional, sin drama (Cap 3, hombro).

## Mission / rank history

| Mission | Operation | Rank | Notes |
|---|---|---|---|
...
| Person | Dynamic |
|---|---|
| Oliver | David y Jonatán — lealtad que no calcula. La deuda de Cap 4 y el peso de "once minutos" (Cap 55) sin resolver. |
| Voss | Fue colocado por Voss sin saberlo. Rastrean Kaspar de forma independiente — convergen Cap 64. |
| Ji-ho | Tío. Rango S. Canal encriptado no oficial. La sombra contra la que Park mide todo sin nombrarlo. |
| Cartwright | Amigos cercanos, tono extraoficial. Cap 62: Cartwright menciona Budapest. |
| Yusuf | Dos agentes con experiencia de campo. Cap 62: encuentran rastros de Kaspar juntos. |
| Elena Krauss (Libro 2) | Rango 2, Domain Rastro (lee perturbación residual en la densidad ambiental de Odem, se desvanece con las horas). Equipo Lev/Sabine. Desconfía de explicaciones que exculpan a AMAT sin más — Park no sabe todavía por qué. Lev puede alisar el rastro a propósito (extracción de Odem, ya establecida como su uso avanzado) — el equipo lo descubre en Cap 76. |
...
**Libro 2 (numeración absoluta):** NO pasa por San Gotardo — despliegue inmediato, horas después de la Irrupción (Cap 76, apertura in media res), directo tras el rastro fresco de Lev y Sabine. No elección propia. Equipo: Elena Krauss (Rango 2, Domain Rastro), Marc Delacroix y Sofia Reyes (Rango 3, ambos sin Domain) — el arco de Libro 2 sigue también la relación con estos tres, no solo la misión. **Progresión (numeración actualizada 2026-07-24 tras la reestructura de Fases):** Cap 76 (apertura), Cap 89 (excepción de POV — Lev/Sabine, el equipo pierde el rastro en el piso franco), Cap 94 (Casi — primer contacto real, sin captura, Sofia sale herida, primera duda real sobre si el expediente oficial encaja con lo que ve), Cap 103 (Sabine — confirman que son reales y localizables), Cap 108 (Localizados — los encuentran de verdad, persecución sin captura, los escucha), Cap 111 (Casi los deja ir — la oportunidad real, no lo hace), Cap 112 (Otra fisura — cuestiona el protocolo mismo, eco directo de Grayhaven M3), Cap 113 (Captura — se salta un paso del protocolo para minimizar daño, sin reportarlo, primera fisura real desde Grayhaven). Silenciosa, sin confrontar a Voss. Queda sin resolver al cierre del libro — hilo abierto hacia Libro 3, junto con el "casi los deja ir" que nunca cuenta a nadie. El hilo "Park no sabe que Voss lo colocó" (Libro 1) sigue abierto, ahora sembrado dentro de su propia línea de campo en vez de en San Gotardo (ver Cap 76: la llamada de Voss no explica por qué él).

**Cap 89 — excepción de POV (Lev/Sabine, no Park):** el equipo pierde el rastro de nuevo tras un encuentro entre Lev/Sabine y su contacto de recursos, Aurelio — visto solo desde fuera, el capítulo cierra con el coche del equipo parado frente al piso ya vacío de la pareja, más cerca de lo que ellos creen. Aurelio queda como cabo suelto — pista real para la próxima entrega de línea D (Cap94).

**Cap 94 — Casi:** vuelve a POV Park. Llegan al piso franco horas después de que lo vaciaran — esta vez el rastro de Lev quedó menos limpio (salida apresurada). Localizan e interrogan a Aurelio (identificado como el hombre del coche de Cap76) — asustado, cooperativo, sigue sin saber quiénes son de verdad. Rastrean hasta un andén de carga — primer contacto físico real, sin captura. Lev, acorralado, libera una ráfaga de calor destructiva (extraída de un contenedor hasta el límite) — no premeditada, reacción de pánico. Sofia sale herida por un fragmento del contenedor, no por ataque directo. Lev y Sabine escapan. Cierre: Park nota que su reacción (correr hacia Sabine, no rematar) no encaja con el expediente que le dieron — primera duda real sin verbalizar todavía.

## Childhood / Background

<!-- canonical — BSA Cap 17 -->
...
- En esas visitas, Park notó que el apartamento "se hacía más pequeño" y que los adultos redistribuían su atención sin decidirlo. No tenía vocabulario para eso entonces. BSA Cap 17: lo identifica como la densidad de Odem de Ji-ho — la misma cualidad que sintió en el perímetro norte de Hartford.
- Para el campfire de BSA Cap 17, Park tenía más información sobre Ji-ho de la historia contada por un agente mayor (caso Sampoong, 1995) que de todo el tiempo que habían pasado en el mismo espacio.
...
- 3 pending access requests filed on arrival: (1) informe 1952-HFD-002, (2) Apéndice C del testimonio de S-0, (3) correspondencia AMAT-EU primeras 48h. All pending as of BSA Cap 8.
