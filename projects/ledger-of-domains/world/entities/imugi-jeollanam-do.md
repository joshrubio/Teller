---
id: imugi-jeollanam-do
type: entity
project: ledger-of-domains
module: world
tags: [potestad, imugi, jeollanam-do, bsa-arc2, nivel-1, ji-ho]
load-with: [world/amat-kr-branch, world/isla-jeollanam-do, characters/ji-ho]
updated: 2026-07-02
---

# Imugi de Jeollanam-do
...
El mito coreano describe al imugi como una serpiente que lleva siglos intentando completar su transformación en yong (용, dragón real) — para eso necesita atrapar una yeouiju. Si la transformación fracasa o se interrumpe, la entidad queda varada en forma intermedia: serpentino, masivo, con fragmentos de escama donde la transformación avanzó y piel desnuda donde nunca llegó a tocarla.

No es un Principado en sentido estándar — es algo adyacente. No puede completar lo que intenta ser y no puede disolverse porque el sustrato, alimentado por mitología viva y por el trauma acumulado de la isla (Guerra de Korea, ferry Sewol), lo define con demasiada precisión para que se extinga.

**Culto histórico:** antes de la operación AMAT, comunidades costeras lo adoraban como deidad local — sin distinción real entre benevolencia y peligro, la misma reverencia con la que se trata algo que puede dar la pesca del año o ahogarte. Restos de un templo (piedra tallada, altar sin ofrendas desde antes de la guerra) permanecen sin cartografiar por completo en el interior de la isla.

## Domain — el imugi

**Acumulación pasiva:** absorbe Odem del sustrato continuamente, sin gesto activo. Setenta años de esta acumulación lo hacen el mayor depósito de Odem de la isla.
...
El cuerpo no se disuelve del todo — se separa en segmentos, cada uno todavía con Odem denso, sin coherencia entre sí. El núcleo queda entre los restos. El escuadrón de Deposición lo recolecta junto con los restos del dokkaebi anciano y la quimera evolucionada de la misma operación.
