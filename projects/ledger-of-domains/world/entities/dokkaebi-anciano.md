...
module: world
tags: [potestad, dokkaebi, jeollanam-do, bsa-arc2, nivel-2]
load-with: [world/amat-kr-branch, world/isla-jeollanam-do]
updated: 2026-07-02
---

# Dokkaebi Anciano — Jeollanam-do Entity
...
Espíritu de lugar, no de persona — ver `amat-kr-branch.md` para la distinción de origen dokkaebi/gwisin. Proporciones geológicas: tronco más largo que las extremidades, hombros a una altura que no corresponde al resto del cuerpo, sin cara ni ropa identificable. El núcleo denso de Odem es visible como presión en el aire incluso a distancia.

Setenta años de exposición a operaciones AMAT sucesivas — sin resolución nunca completa — lo hicieron crecer más allá del dokkaebi estándar de la isla, tanto en escala como en capacidad.

## Domain — el anciano

**Dos velocidades:** se mueve lento en reposo o aproximación normal, y cambia a una velocidad imposible para su tamaño sin transición perceptible. No hay aviso físico del cambio — el cuerpo que trabajaba lento un instante antes cierra quince metros en menos de un segundo. Esta capacidad no está documentada en ninguna otra instancia de dokkaebi.

**Quemadura al contacto:** superficie que activa Odem ajeno al tocar piel o metal — el cuerpo lo lee como quemadura real sin fuego. El Clase-R se activa al máximo intentando compensar; no siempre es suficiente.

**Onda de presión desde una herida:** capacidad original, no documentada antes de esta instancia. El Odem denso de un miembro cercenado se acumula en el punto de corte en vez de dispersarse. La entidad puede liberar esa compresión como onda de presión pura al golpear con el muñón — sin necesidad de contacto directo del "arma" en sí, el aire desplazado por el golpe transporta la fuerza.
